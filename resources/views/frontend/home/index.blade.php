                ...
                <div class="carausel-10-columns" id="carausel-10-columns">
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-13.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-12.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-11.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-9.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-3.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-1.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-4.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-5.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('assets/frontend/imgs/shop/cat-14.png') }}"
                                    alt="" /></a>
                        </figure>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            ...
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-1-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="product-cart-wrap mb-30" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-4-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-4-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
                            ...
                            <div class="product-cart-wrap mb-30" data-wow-delay=".5s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-5-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-5-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
                            ...
                            <div class="product-cart-wrap" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-6-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-6-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
                            ...
                            <div class="product-cart-wrap" data-wow-delay=".2s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-7-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-7-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
                            ...
                            <div class="product-cart-wrap" data-wow-delay=".3s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-8-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-8-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
                            ...
                            <div class="product-cart-wrap" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-9-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-9-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <img src="{{ asset('assets/frontend/imgs/banner/banner-16.png') }}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                        <img src="{{ asset('assets/frontend/imgs/banner/banner-17.png') }}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                        <img src="{{ asset('assets/frontend/imgs/banner/banner-18.png') }}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                        <img src="{{ asset('assets/frontend/imgs/banner/banner-19.png') }}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-7-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-7-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-8-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-8-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-9-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-9-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-3-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-3-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-1-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-1-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-2-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-2-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
    ...
    <section class="wsus__ctg mt-40">
        <div class="container">
            <a href="#" class="wsus__ctg_area">
                <img src="{{ asset('assets/frontend/imgs/cta_bg.png') }}" alt="cta" class="img-fluid w-100" />
            </a>
        </div>
    </section>
    <!--CTA section end-->
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-4-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-4-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-5-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-5-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                ...
                <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="#" tabindex="-1">
                                    <img class="default-img" src="{{asset('assets/frontend/imgs/shop/product-6-1.jpg')}}"
                                        alt="">
                                    <img class="hover-img" src="{{asset('assets/frontend/imgs/shop/product-6-2.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
            ...
            <div class="row">
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-1.jpg')}}" alt="" /></a>
                            </figure>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-2.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                                    <a href="#">Classic Slim-Fit Denim Jeans – Men's Stretchable Mid-Rise</a>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-3.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                                    <a href="#">Classic Slim-Fit Denim Jeans – Men's Stretchable Mid-Rise</a>
                ...
                <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-4.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-5.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-6.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                ...
                <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-7.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-8.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-9.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                ...
                <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-10.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-11.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/imgs/shop/thumbnail-12.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
