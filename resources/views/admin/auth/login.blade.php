...
<head>
    ...
    <link href="{{ asset('admin/css/tabler-flags.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/tabler-socials.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/tabler-payments.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/tabler-vendors.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/tabler-marketing.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/css/tabler-themes.css') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
...
<body>
    ...
    <script src="./dist/js/tabler.min.js?1750026890" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="./preview/js/demo.min.js?1750026890" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
